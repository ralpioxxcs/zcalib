...
// homography opt
vector<Point_<double>>* objPtr;
vector<Point_<double>>* imgPtr;
// refine opt
vector<double>* ref_p;
vector<Point_<double>>* ref_objPtr;
vector<vector<Point_<double>>>* ref_imgPtr;
...
void print_test() { std::cout << "test!" << std::endl; }

void curve_fit_all(vector<double>& p_init, vector<Point_<double>> obj,
                   vector<vector<Point_<double>>> img) {
  ref_p = &p_init;
  ref_objPtr = &obj;
  ref_imgPtr = &img;
